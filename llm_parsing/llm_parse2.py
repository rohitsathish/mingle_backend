...
from llm_parse_openrouter import (
    close_httpx_client,
    get_link_markdown,
...
class MessagesProcessor:
    ...
    async def _process_chunk(
        ...
        try:
            ...
            chunk_result = {
                ...
                "category_updates": {
                    "new_categories": list(response.category_updates.new_categories)
                },
            }
    ...
    def _combine_responses(self, responses: List[Dict[str, Any]]) -> Dict[str, Any]:
        ...
        if not responses:
            return {"events": [], "category_updates": {"new_categories": []}}
        ...
        for response in responses:
            ...
            if (
                "category_updates" in response
                and "new_categories" in response["category_updates"]
            ):
                combined_categories.update(
                    response["category_updates"]["new_categories"]
                )
        ...
        return {
            ...
            "category_updates": {"new_categories": list(combined_categories)},
        }
