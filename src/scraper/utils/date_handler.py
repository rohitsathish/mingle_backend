"""Date utilities for WhatsApp message parsing.

Handles conversion of WhatsApp's relative date references to actual dates.
"""
...
def get_whatsapp_date_mapping() -> Dict[str, datetime.date]:
    ...
    mapping = {"TODAY": today.date(), "YESTERDAY": (today - timedelta(days=1)).date()}
